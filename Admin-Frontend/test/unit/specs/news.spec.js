...
describe('信息列表界面', () => {
    ...
    it('检查页面元素', () => {
        expect(vm.$el.querySelector(".el-menu-item.menu-item.is-active span").textContent).to.be.equal("消息管理");
    ...
    it('检查信息列表显示', done => {
        vm.news_list = [{ 'news_title': "test", 'publish_time': 1544369401, "news_id": 1 }]
        vm.page_end = 1;
        vm.total_len = 1;
        Vue.nextTick(() => {
