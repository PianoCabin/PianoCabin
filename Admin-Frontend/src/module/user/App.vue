        ...
        <div class="filter">
          <el-row>
            <div class="search-item fl">
              <span>预约权限：</span>
              <el-select @change="handleFilter" :value="0" v-model="filter_info.order_permission" style="width: 7rem">
            ...
            <div class="search-item fl">
              <span>绑定身份：</span>
              <el-select @change="handleFilter" :value="0" v-model="filter_info.permission" style="width: 7rem">
  ...
  export default {
    ...
    methods: {
      ...
      selectALlChange: function (status) {
        ...
        for (let i = 0; i < len; i++)
          this.user_list[i].order_permission = status
      ...
      handlePermissionChange: function () {
        Utils.post(this, '/a/user/edit/', {"user_list": this.user_list}, function (_this, res) {
          if (res.code === 0) {
